...
# Иерархия групп. Что такое глобальный уровень
...
Но глобальный уровень должен появиться сам. Ради этого и строится иерархия.
...
Если сверху подтверждает только одна сущность, то этой сущности ничего не стоит создать бот-нет. Эта сущность на 100% уверена в своей ветке. По этой причине не будет работать модель с простыми приглашениями. 
